...
<div class="container-fluid">
    ...
    <div class="card my-2">
        <div class="card-body">
            <form action="<?= base_url('part/insert') ?>" method="post" id="form_part">
                <div class="form-row">
                    <div class="form-group col-sm-4">
                        <label for="nama_part">Nama Part <font color="red">*</font></label>
                        <input class="form-control" type="text" name="nama_part" id="nama_part" placeholder="Nama Part" />
                        <span id="error_nama_part" class="text-danger"></span>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for="kode_part">Kode Part <font color="red">*</font></label>
                        <input class="form-control" type="text" name="kode_part" id="kode_part" placeholder="Kode Part" />
                ...
                <div class="form-row">
                    <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" type="text" name="jenis_part" id="jenis_part" placeholder="Jenis Part" />
